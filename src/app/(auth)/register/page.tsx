...
export default function RegisterPage() {
  ...
  return (
    <FitZoom className="flex flex-col gap-8">
      ...
      <form onSubmit={handleSubmit} noValidate className={cn("flex flex-col gap-4", shake.className)} onAnimationEnd={shake.onAnimationEnd}>
        ...
        <ul className="mt-1 grid grid-cols-3 gap-2">
          {[
            ...
            <li
              key={rule.label}
              className={`flex flex-col items-center gap-1 text-center text-[0.65rem] leading-tight ${
      ...
      <div className="grid grid-cols-2 gap-3">
        <Button variant="outline" type="button" onClick={() => toast.success("Google sign-up is coming soon")}>
        ...
        <Button variant="outline" type="button" onClick={() => toast.success("GitHub sign-up is coming soon")}>
          <svg className="size-4" viewBox="0 0 24 24" fill="currentColor">
